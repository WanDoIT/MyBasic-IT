...
public class Main {
	public static void main(String[] args) {
		PersonVO[] persons = { new PersonVO(1, "수지", 29), new PersonVO(2, "아이유", 30), 
				new PersonVO(3, "카리나", 23), new PersonVO(4, "아담", 46) };

		// Arrays.sort 메서드는 배열을 대입하면 부등호 또는 compareTo라는 메서드를 호출해서
		// 크기 비교를 한 후 정렬을 수행한다.
		// Arrays.sort(persons); // PersonVO 에는 크기 비교를 할 수 있는 메서드가 없기떄문에 에러
...
//		});
		...
		// 배열의 데이터 출력
		// Arrays.toString은 배열의 각 요소에 toString을 전부 호출해서 하나의 문자열로 리턴.
