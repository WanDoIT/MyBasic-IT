		...
		x:while(true) {
			...
			case 2:
				...
				if (index<=0) {
					...
					index--;
					System.out.print("이전정보 이름 : "+nameList[index]+"\n");
					System.out.print("이전정보 성별 : "+genderList[index]+"\n");
					System.out.print("이전정보 나이 : "+ageList[index]+"\n");
			...
			case 6:
				...
				if (index >= 0 && index <count) {
					...
					System.out.println("현재위치에 삭제할 정보가 없습니다");
				}
					break;
